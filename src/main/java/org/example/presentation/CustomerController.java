...
public class CustomerController {
    ...
    private void showMenu() {
        System.out.println("\n═══════════════════════════════════════");
        System.out.println("ГЛАВНОЕ МЕНЮ [Роль: CUSTOMER]");
        System.out.println("═══════════════════════════════════════");
    ...
    private void showAllHotels() {
        ...
        while (hasMorePages) {
            ...
            System.out.printf("\n=== ДОСТУПНЫЕ ОТЕЛИ (Страница %d из %d) ===%n",
                    page + 1, hotelPage.getTotalPages());
            System.out.printf("Всего отелей: %d, Показано: %d%n",
                    hotelPage.getTotalElements(), hotelPage.getNumberOfElements());
            System.out.println("---");

            for (HotelResponseDto hotel : hotelPage.getContent()) {
                ...
                switch (input) {
                    ...
                    case "p" -> {
                        if (page > 0) {
                            ...
                            System.out.println("Вы уже на первой странице.");
                        }
                    }
                    case "q" -> hasMorePages = false;
    ...
    private void showMyBookings() {
        ...
        while (hasMorePages) {
            ...
            Page<BookingResponseDto> bookingPage = bookingService.getBookingsByUser(currentUser.userId(), pageable);
            ...
            System.out.printf("\n=== МОИ БРОНИРОВАНИЯ (Страница %d из %d) ===%n",
    ...
    private void showMyCancelRequests() {
        ...
        while (hasMorePages) {
            ...
            Page<CancelRequestDto> requestPage = cancelRequestService.getCancelRequestsByUser(currentUser.userId(), pageable);
            ...
            System.out.printf("\n=== МОИ ЗАПРОСЫ НА ОТМЕНУ (Страница %d из %d) ===%n",
