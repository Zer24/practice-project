...
public class AuthController implements CommandLineRunner {
    ...
    private void redirectToRoleController() {
        switch (currentUser.role()) {
            case CUSTOMER -> customerController.start(currentUser);
            case MANAGER -> managerController.start(currentUser);
            case ADMIN -> adminController.start(currentUser);
        }
    }
}